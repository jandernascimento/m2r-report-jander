...
Before describe Risk Assessment and its relation with ADAS, we have first to understand what risk means.
...
For that reason some literature use terms like hazard or threat to refer to negative risks. But in this document when we refer to risk, we mean the negative risk - something happens to be true something bad may happen to the subject.

As we saw in certain level of details the meaning of risk, now we can understand the whole meaning of the term, but not without first understanding what "assessment" means.

The \textbf{assessment} is the action of study what variations can affect the subject, this variation can be \textbf{direct} or \textbf{indirect} as well, but we will not explain in details, it is sufficient to know that something it is related with the "thing" that affects the subject, did it happened directly with the subject? or indirectly?

One good example to illustrate the \textbf{direct} and \textbf{indirect} situations, imagine you bought a very good amount of shares from Apple Inc\copyright. But you forgot that its products are manufactured in an asian country and suddenly this asian country government annouces that it is forbiden to export of any kind of product to western countries. 
...
Thus, the subject can be anything with enough degree of importance to justify the risk assessment. Some examples are: a project, stocks, a schedule, an action.
