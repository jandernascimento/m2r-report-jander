...
On the East image, at the bottom on the right side, we can see some noise that probably was generated by the inconstant height of guardrail. The height variation is not large but enough to produce a false positive in our experiments.
